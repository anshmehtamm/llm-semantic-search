...
def main():
    ...
    # !!! Make sure load_evaluation_data is adapted for your dataset !!!
    ...
    # Optional: Subset data for quicker testing
    ...
    # This will load the embedding model and the pre-built FAISS index
